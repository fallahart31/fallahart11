            ...
            <div class="modal-body">
                <form class="form-grup" action="#" method="post">
                  <div class="input-grup">
                    ...
                    <input type="number" class="form-control" name="bakwan" id="bakwan" placeholder="Masukan Jumlah Bakso Yang Ingin Dibeli *" readOnly>
                  </div>
                  <br>
                  <div class="input-grup">
                    <span class="input-grup-addon"><i class="fa fa-cutlery"></i></span>
                    <input type="number" class="form-control" name="bakso" id="bakso" placeholder="Masukan Jumlah Bakwan Yang Ingin Dibeli *" readOnly>
                  </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="exit()" class="btn btn-default" data-dismiss="modal"><i class="fa fa-close"></i> Kembali </button>
